      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="mt-4 text-3xl font-bold text-ink-900 tracking-tight">Optimization Pipeline</h2>
              ...
              <div key={stage.title}>
                <div className="flex items-center gap-4 lg:gap-6">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center">
                    <div className="w-14 h-14 rounded-xl bg-primary-600 flex items-center justify-center shadow-sm">
                  ...
                  <Card className="flex-1 p-5 lg:p-6">
                    <div className="flex items-start gap-3">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-ink-500 leading-relaxed">{stage.desc}</p>
                      </div>
                    </div>
                  </Card>
                </div>
      ...
      <section className="py-16 lg:py-20 bg-ink-50 border-y border-ink-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="mt-4 text-3xl font-bold text-ink-900 tracking-tight">
            ...
            <Card className="p-8">
              ...
              <div className="space-y-4">
                {standardDetail.map((row) => (
                  <div key={row.label} className="flex items-start justify-between gap-4 pb-3 border-b border-ink-100 last:border-0">
                    <span className="text-sm font-medium text-ink-500">{row.label}</span>
                    <span className="text-sm text-ink-600 text-right flex items-center gap-2">
                      <XCircle className="w-4 h-4 text-ink-400 flex-shrink-0" />
                      {row.value}
                    </span>
                  </div>
                ))}
            ...
            <Card className="p-8 border-primary-300 ring-1 ring-primary-200">
              ...
              <div className="space-y-4">
                {nexflowDetail.map((row) => (
                  <div key={row.label} className="flex items-start justify-between gap-4 pb-3 border-b border-ink-100 last:border-0">
                    <span className="text-sm font-medium text-ink-500">{row.label}</span>
                    <span className="text-sm text-ink-800 font-medium text-right flex items-center gap-2">
